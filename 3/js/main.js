...
function init() {
	...
	for(var i = 0; i< 1; i++){
		for(var j = 0; j<1; j++){
		    tube = new Tube(scene, camera, new THREE.Vector3(i*50,0,j*50), new THREE.Vector3(0,0, 0), Math.random());
		    tubes.push(tube);
		}
	}
	...
	// controls = new THREE.OrbitControls(splineCamera);
